    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('actions')}>
                <button className={cx('action-btn')}>出勤</button>
                <button className={cx('action-btn')}>退勤</button>
                <button className={cx('action-btn')}>休憩開始</button>
                <button className={cx('action-btn')}>休憩終了</button>
            </div>
